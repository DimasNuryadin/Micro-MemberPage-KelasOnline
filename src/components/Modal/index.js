  ...
  return (
    <>
      ...
      {document && document.getElementById(idModal) && <div>
        {
          createPortal(
            <CSSTransition nodeRef={ModalRef} in={props.in ?? display} timeout={500} onExit={toggleAllow} onExited={toggleAllow} classNames="overlay" unmountOnExit>
              <div className="overlay fixed inset-0 h-screen z-50">
                ...
                <div className="absolute z-20 flex items-center justify-center inset-0">
                  <div className="bg-white shadow-2xl max-w-3xl max-h-2xl" style={props.modalStyle} ref={ModalRef}>
